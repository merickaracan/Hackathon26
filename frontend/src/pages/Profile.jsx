...
import { updateNotifications, updateProfile } from '../api/users'
        ...
        <div className="px-7 pb-7">
          ...
          <div className="-mt-10 mb-4 flex items-end justify-between">
            <button
              ...
              className="relative w-20 h-20 rounded-full border-4 border-white shadow-sm group focus:outline-none"
              title="Change profile picture"
            >
              {avatar ? (
                <img src={avatar} alt={name} className="w-full h-full rounded-full object-cover" />
              ) : (
                <div className="w-full h-full rounded-full bg-brand flex items-center justify-center text-white text-2xl font-bold font-display">
                  {initials}
                </div>
              )}
              <div className="absolute inset-0 rounded-full bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                <span className="text-white text-[10px] font-semibold font-body tracking-wide">
            ...
            <div className="space-y-4">
              {sessionsLoading ? (
                ...
                <div className="bg-white rounded-2xl p-8 border border-border text-center">
                  ...
                  <p className="font-display text-base font-semibold text-text-main">No upcoming sessions</p>
                  <p className="text-xs text-text-muted font-body mt-1">Post a session to see it here.</p>
                </div>
